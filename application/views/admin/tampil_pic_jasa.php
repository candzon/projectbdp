...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <div class="panel panel-default">
        ...
        <?php echo anchor('data_vendor_ga/tambah_pic_jasa/'.$this->uri->segment(3),'<button class="btn btn-sm btn-primary mb-2"><i class="fas fa-plus"></i> Tambah</button>')?>
        </div>
        ...
        <table class="table table-bordered table-striped table-hover table-sm small">
            ...
            <?php foreach($data as $vendor):?>
                <tr  align="center">
                    ...
                    <td>
                    <?php echo anchor('data_vendor_ga/edit_pic_jasa/'.$vendor->id_pic_vendor, '<div class="btn btn-success btn-sm">Ubah</div>')?>
   ...
   function deletedata(){
    $('.delete').click(function(){
        ...
        swal({
            ...
            window.location = "../hapus_pic_jasa/"+id_pic_vendor+""
        })
      });
   }
</script>