<div class="container-fluid">
    ...
    <div class="panel panel-default">
        ...
        <?php echo anchor('data_karyawan/tambah_karyawan','<button class="btn btn-sm btn-primary mb-4"><i class="fas fa-plus"></i> Tambah</button>')?>
        <?php echo anchor('data_karyawan/tampil_data_karyawan','<button class="btn btn-sm btn-danger mb-4"><i class="fa fa-times" aria-hidden="true"></i> Kembali</button>')?>
