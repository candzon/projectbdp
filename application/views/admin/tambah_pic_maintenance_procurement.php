...
<div class="row">
    ...
    <form method="post" action="<?php echo base_url('data_vendor_ga/tambah_pic_maintenance_aksi_procurement/'.$this->uri->segment(3))?>">
        ...
        <?php echo anchor('data_vendor_ga/tampil_maintenance_ga_procurement','<div class="btn btn-danger btn-sm hapus_pakar">Batal</div>')?>
