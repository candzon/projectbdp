...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Data PIC Vendor Jasa</h1>
    </div>
    
    <div class="panel panel-default">
        <div class="panel-heading mb-4">
        <?php echo anchor('data_vendor_ga/tambah_pic_jasa_procurement/'.$this->uri->segment(3),'<button class="btn btn-sm btn-primary mb-2"><i class="fas fa-plus"></i> Tambah</button>')?>
        </div>
        ...
        <table class="table table-bordered table-striped table-hover table-sm small">
            ...
            <?php foreach($data as $vendor):?>
                <tr  align="center">
                    ...
                    <td>
                    <?php echo anchor('data_vendor_ga/edit_pic_jasa_procurement/'.$vendor->id_pic_vendor, '<div class="btn btn-success btn-sm">Ubah</div>')?>
   ...
   function deletedata(){
    $('.delete').click(function(){
        ...
        swal({
            ...
            window.location = "../hapus_pic_jasa_procurement/"+id_pic_vendor+""
        })
      });
   }
</script>