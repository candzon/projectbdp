...
<div class="row">
    ...
    <form method="post" action="<?php echo base_url('data_vendor_ga/tambah_vendor_ga_aksi_procurement')?>">
        ...
        <?php echo anchor('dashboard_procurement/index','<div class="btn btn-danger btn-sm hapus_pakar">Batal</div>')?>
