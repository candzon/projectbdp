<div class="container-fluid">
    ...
    <div class="panel panel-default">
        ...
        <?php echo anchor('data_vendor_ga/tampil_jasa_ga','<button class="btn btn-sm btn-danger mb-4"><i class="fa fa-times" aria-hidden="true"></i> Kembali</button>')?>
            <form class="form-inline"  method="post" action="<?php echo base_url('data_vendor_ga/pencarian_jasa') ?>">
    ...
    <?php if($data != null):?>
        ...
        <?php foreach($data as $vendor):?>
                <tr  align="center">
                    ...
                    <td>
                    <?php echo anchor('data_vendor_ga/tampil_pic_jasa/'.$vendor->id_vendor, '<div class="btn btn-info btn-sm">PIC Vendor</div>')?>    
                    <?php echo anchor('data_vendor_ga/edit_jasa_ga/'.$vendor->id_vendor, '<div class="btn btn-success btn-sm">Ubah</div>')?>
   ...
   function deletedata(){
    $('.delete').click(function(){
        ...
        swal({
            ...
            window.location = "../data_vendor_ga/hapus_jasa/"+id_vendor+""
        })
      });
   }
</script>