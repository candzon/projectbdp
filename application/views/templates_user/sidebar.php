<body id="page-top">
	...
	<div id="wrapper">
        ...
        <div class="sidebar-brand-text mx-3">GA Building Management BCAi</div> -->
			...
			<!-- Nav Item - Dashboard -->
			<li <?= $this->uri->segment(1) == 'data_akun' ? 'class="nav-item active"' : 'class="nav-item"' ?>>
				<a class="nav-link" href="<?php echo base_url('data_akun/ubah_kata_sandi/' . $_SESSION['nama_akun']) ?>">
					<i class="fas fa-id-card"></i>
					<span>Ubah Kata Sandi</span></a>
			</li>

			<!-- Nav Item - Dashboard -->
			<li <?= $this->uri->segment(1) == 'dashboard_user' ? 'class="nav-item active"' : 'class="nav-item"' ?>>
				<a class="nav-link" href="<?php echo base_url('dashboard_user/index') ?>">
        ...
        <i class="fas fa-fw fa-building"></i>
          <span>Data Kantor</span></a>
			...
			<li
				...
				<a class="nav-link" href="<?php echo base_url('data_kendaraan/tampil_data_kendaraan_building') ?>">
			...
			<li
				...
				<a class="nav-link" href="<?php echo base_url('data_masa_sewa/tampil_masa_sewa_building') ?>">
