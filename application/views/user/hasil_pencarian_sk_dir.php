<div class="container-fluid">
    ...
    <div class="panel panel-default">
        ...
        <?php echo anchor('data_sk_dir/tampil_data','<button class="btn btn-sm btn-danger mb-4"><i class="fa fa-times" aria-hidden="true"></i> Kembali</button>')?>
    ...
    <?php if($data == null):?>
        <div class="container-fluid mt-3">
            <div class="alert alert-primary">
                ...
                Data SK Direksi Tidak Ditemukan!
                </h4>
            </div>
        </div>
    <?php endif;?>
