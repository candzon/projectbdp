...
<div class="row">
    ...
    <form action="<?php echo base_url('data_akun/ubah_kata_sandi_aksi/'.$akun->nama_akun)?>" 
    method="post">
            ...
            <div class="form-group">
                ...
                <input type="password" name="password_lama" class="form-control" autocomplete="off" placeholder="Masukkan Kata Sandi Lama">
            ...
            <div class="form-group mt-4">
                ...
                <input type="password" name="password_baru" class="form-control" autocomplete="off" placeholder="Masukkan Kata Sandi Baru">
            ...
            <div class="form-group mt-4">
                ...
                <input type="password" name="ulangi_password" class="form-control" autocomplete="off" placeholder="Masukkan Kata Sandi Baru">
                <?php echo form_error('ulangi_password','<div class="text-danger small ml-2 mt-2">','</div>');?>
            </div>
            
            <div class="modal-footer">          
            <?php echo anchor('dashboard_user','<div class="btn btn-danger btn-sm hapus_pakar">Batal</div>')?>
