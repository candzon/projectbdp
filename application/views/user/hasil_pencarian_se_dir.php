<div class="container-fluid">
    ...
    <div class="panel panel-default">
        ...
        <?php echo anchor('data_se_dir/tampil_data','<button class="btn btn-sm btn-danger mb-4"><i class="fa fa-times" aria-hidden="true"></i> Kembali</button>')?>
            <form class="form-inline"  method="post" action="<?php echo base_url('data_se_dir/pencarian') ?>">
    ...
    <?php if($data == null):?>
        <div class="container-fluid mt-3">
            <div class="alert alert-primary">
                ...
                Data Se Direksi Tidak Ditemukan!
                </h4>
            </div>
        </div>
    <?php endif;?>
