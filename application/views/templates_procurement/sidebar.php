      ...
      <li  <?=$this->uri->segment(2) == 'tampil_data_akun' || $this->uri->segment(1) == 'data_akun' || $this->uri->segment(2) == 'tampil_data_vendor' || $this->uri->segment(1) == 'data_vendor' || $this->uri->segment(2) == 'tampil_data_karyawan' || $this->uri->segment(1) == 'data_karyawan' || $this->uri->segment(2) == 'tampil_alamat' || $this->uri->segment(1) == 'data_alamat'? 'class="nav-item active"':'class="nav-item"'?>>
        ...
        <div id="collapseOne" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?php echo base_url('data_vendor_ga/tambah_vendor_ga_procurement')?>">Tambah Data Vendor</a>
            <a class="collapse-item" href="<?php echo base_url('data_vendor_ga/tampil_pengadaan_ga_procurement')?>">Pengadaan</a>
            <a class="collapse-item" href="<?php echo base_url('data_vendor_ga/tampil_maintenance_ga_procurement')?>">Service / Maintenance</a>
            <a class="collapse-item"  href="<?php echo base_url('data_vendor_ga/tampil_jasa_ga_procurement')?>">Jasa</a>
          </div>
        </div>
      </li>
